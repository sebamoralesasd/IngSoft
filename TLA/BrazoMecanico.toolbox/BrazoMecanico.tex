...
\@x{}\moduleLeftDash\@xx{ {\MODULE} BrazoMecanico}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{T}{F}{5.0}{0}{}%
\ensuremath{{\EXTENDS}} timer
\end{cpar}%
\begin{cpar}{1}{F}{F}{0}{0}{}%
 \ensuremath{{\CONSTANTS}} \ensuremath{tIr}, \ensuremath{tDet},
 \ensuremath{tExt
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{{\ASSUME} \.{\land} tIr \.{\in} Nat
}%
\end{cpar}%
\begin{cpar}{0}{T}{F}{17.5}{0}{}%
\ensuremath{\.{\land} tIr \.{>} 0
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\land} tDet \.{\in} Nat
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\land} tDet \.{>} 0
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\land} tExt \.{\in} Nat
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\land} tExt \.{>} 0
}%
\end{cpar}%
\end{lcom}%
\@x{ {\VARIABLES} direccion ,\, pos ,\, bRunning}%
\@y{%
 , \ensuremath{timeElapsed
}}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{ vr\@s{0.51} \.{\defeq} {\langle} direccion ,\, pos ,\, bRunning
 {\rangle}\@s{14.35}}%
\@y{%
 , \ensuremath{timeElapsed{\rangle}
}}%
\@xx{}%
\@x{ ar \.{\defeq} {\langle} pos ,\, direccion {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ TypeInv \.{\defeq} \.{\land} direccion \.{\in} \{\@w{izq} ,\,\@w{der}
 \}}%
\@x{\@s{54.48} \.{\land} pos \.{\in} \{\@w{izq} ,\,\@w{der} ,\,\@w{mid} \}}%
\@x{\@s{54.48} \.{\land} bRunning \.{\in} \{\@w{yes} ,\,\@w{no} \}}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq} \.{\land} TypeInv}%
\@x{\@s{35.70} \.{\land} direccion \.{=}\@w{izq}}%
\@x{\@s{35.70} \.{\land} pos \.{=}\@w{izq}}%
\@x{\@s{35.70} \.{\land} bRunning \.{=}\@w{no}}%
\@pvspace{8.0pt}%
\@x{ MoveTo ( p ) \.{\defeq} \.{\land} direccion \.{\neq} p}%
\@x{\@s{67.81} \.{\land} bRunning \.{=}\@w{no}}%
\@x{\@s{67.81} \.{\land} bRunning \.{'} \.{=}\@w{yes}}%
\@x{\@s{67.81} \.{\land} direccion \.{'} \.{=} p}%
\@x{\@s{67.81} \.{\land} pos \.{'} \.{=}\@w{mid}}%
\@pvspace{8.0pt}%
\@x{ Extremo ( p ) \.{\defeq} \.{\land} pos\@s{1.24} \.{=}\@w{mid}}%
\@x{\@s{69.37} \.{\land} direccion \.{=} p}%
\@x{\@s{69.37} \.{\land} bRunning \.{=}\@w{yes}}%
\@x{\@s{69.37} \.{\land} bRunning \.{'} \.{=}\@w{no}}%
\@x{\@s{69.37} \.{\land} pos \.{'} \.{=} p}%
 \@x{\@s{69.37} \.{\land} direccion \.{'} \.{=} {\CHOOSE} x \.{\in} \{\@w{izq}
 ,\,\@w{der} \} \.{:} x \.{\neq} p}%
\@pvspace{8.0pt}%
\@x{ StopMid \.{\defeq} \.{\land} pos \.{=}\@w{mid}}%
\@x{\@s{56.23} \.{\land} bRunning \.{=}\@w{yes}}%
\@x{\@s{56.23} \.{\land} bRunning \.{'} \.{=}\@w{no}}%
\@x{\@s{56.23} \.{\land} {\UNCHANGED} ar}%
\@pvspace{8.0pt}%
\@x{ Reanudar \.{\defeq} \.{\land} pos \.{=}\@w{mid}}%
\@x{\@s{61.37} \.{\land} bRunning \.{=}\@w{no}}%
\@x{\@s{61.37} \.{\land} bRunning \.{'} \.{=}\@w{yes}}%
\@x{\@s{61.37} \.{\land} {\UNCHANGED} ar}%
\@pvspace{8.0pt}%
\@x{ BStop\@s{0.13} \.{\defeq} StopMid \.{\lor} Extremo ( direccion )}%
\@pvspace{8.0pt}%
\@x{ Boton \.{\defeq} BStop \.{\lor} Reanudar}%
\@pvspace{8.0pt}%
 \@x{ Next \.{\defeq} Boton \.{\lor} ( \E\, p \.{\in} \{\@w{izq} ,\,\@w{der}
 \} \.{:} MoveTo ( p ) \.{\lor} Extremo ( p ) )}%
\@pvspace{8.0pt}%
 \@x{ Spec\@s{1.46} \.{\defeq} Init \.{\land} {\Box} [ Next ]_{ vr} \.{\land}
 {\WF}_{ vr} ( Next )}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@x{ {\THEOREM} Spec \.{\implies} {\Box} TypeInv}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Feb} 28 20:10:25 ART 2022 by \ensuremath{sebapc
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sun \ensuremath{Feb} 27 21:47:50 ART
 2022 by \ensuremath{sebapc
}%
\end{cpar}%
\end{lcom}%
\end{document}
