...
\@x{}\moduleLeftDash\@xx{ {\MODULE} timer}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Naturals ,\, RealTime}%
\@x{ {\VARIABLES} time ,\, running ,\, limit}%
\@pvspace{8.0pt}%
\@x{ TTypeInv \.{\defeq} \.{\land} time \.{\in} Nat}%
\@x{\@s{61.64} \.{\land} limit \.{\in} Nat}%
\@x{\@s{61.64} \.{\land} running \.{\in} \{\@w{yes} ,\,\@w{no} \}}%
\@pvspace{8.0pt}%
\@x{ av \.{\defeq} {\langle} limit ,\, time ,\, running {\rangle}}%
 \@x{ sv\@s{1.02} \.{\defeq} {\langle} limit ,\, time ,\, running ,\, now
 {\rangle}}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
\@x{ TInit \.{\defeq} limit \.{=} 0 \.{\land} running \.{=}\@w{no}}%
\@pvspace{8.0pt}%
\@x{ Set ( l ) \.{\defeq} \.{\land} l\@s{4.54} \.{>} 0}%
\@x{\@s{44.74} \.{\land} running \.{=}\@w{no}}%
\@x{\@s{44.74} \.{\land} limit \.{'} \.{=} l}%
 \@x{\@s{44.74} \.{\land} {\UNCHANGED} {\langle} time ,\, now ,\, running
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Start \.{\defeq} \.{\land} running \.{=}\@w{no}}%
\@x{\@s{41.43} \.{\land} limit\@s{1.58} \.{>} 0}%
\@x{\@s{41.43} \.{\land} time \.{'} \.{=} now}%
\@x{\@s{41.43} \.{\land} running \.{'} \.{=}\@w{yes}}%
\@x{\@s{41.43} \.{\land} {\UNCHANGED} {\langle} now ,\, limit {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Timeout \.{\defeq} \.{\land} running \.{=}\@w{yes}}%
\@x{\@s{56.12} \.{\land} now \.{-} time \.{\geq} limit}%
\@x{\@s{56.12} \.{\land} running \.{'} \.{=}\@w{no}}%
 \@x{\@s{56.12} \.{\land} {\UNCHANGED} {\langle} now ,\, time ,\, limit
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Stop \.{\defeq} \.{\land} running \.{=}\@w{yes}}%
\@x{\@s{38.68} \.{\land} running \.{'} \.{=}\@w{no}}%
 \@x{\@s{38.68} \.{\land} {\UNCHANGED} {\langle} now ,\, time ,\, limit
 {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ TNext \.{\defeq} Start \.{\lor} Stop \.{\lor} Timeout \.{\lor} ( \E\, t
 \.{\in} Nat \.{:} Set ( t ) )}%
 \@x{ TSpec\@s{1.46} \.{\defeq} TInit \.{\land} {\Box} [ TNext ]_{ sv}
 \.{\land} RTBound ( Timeout ,\, av ,\, 0 ,\, 1 )}%
\@x{}\midbar\@xx{}%
\@x{ {\THEOREM} TSpec \.{\implies} {\Box} TTypeInv}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\@pvspace{8.0pt}%
\setboolean{shading}{false}
...
\cdash{29} \ensuremath{{\MODULE}} \ensuremath{RealTime} \cdash{31}
 \ensuremath{{\EXTENDS}} Reals, \ensuremath{Naturals
} \ensuremath{{\VARIABLES}} now
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\cdash{77}
\end{cpar}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 (* \ensuremath{Estas} definiciones son de \ensuremath{DK\_RealTime}. Se
 agregaron a este modulo porque *)
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{RTTypeInv \.{\defeq} now \.{\in} Nat
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{RTInit \.{\defeq} now \.{=} 0
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Tick \ensuremath{\.{\defeq} now\.{'} \.{=} now} + 1
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{RTSpec \.{\defeq} RTInit \.{\land} {\WF}\_now(Tick)
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\cdash{77}
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{RTBound(A,\, v,\, D,\, E) \.{\defeq}
}%
\end{cpar}%
\begin{cpar}{0}{T}{F}{5.0}{0}{}%
 \ensuremath{\.{\LET} TNext(t) \.{\defeq} t\.{'} \.{=} {\IF}
 {\langle}A{\rangle}\_v \.{\lor} {\lnot}({\ENABLED}
 {\langle}A{\rangle}\_v)\.{'}
}%
\end{cpar}%
\begin{cpar}{0}{T}{F}{62.5}{0}{}%
\ensuremath{\.{\THEN} 0
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\ELSE} t \.{+} (now\.{'}\.{-}now)
}%
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{1}{T}{F}{10.0}{0}{}%
 \ensuremath{Timer(t) \.{\defeq} (t\.{=}0) \.{\land}
 {\Box}[TNext(t)]\_{\langle}t,\, v,\, now{\rangle}
}%
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{MaxTime(t) \.{\defeq} {\Box}(t \.{\leq} E)
}%
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{MinTime(t) \.{\defeq} {\Box}[A \.{\implies} t \.{\geq} D]\_v
}%
\end{cpar}%
\begin{cpar}{1}{F}{F}{0}{0}{}%
 \ensuremath{\.{\IN} {\EE} t \.{:} Timer(t) \.{\land} MaxTime(t) \.{\land}
 MinTime(t)
}%
\end{cpar}%
\begin{cpar}{1}{F}{F}{0}{0}{}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{RTnow(v) \.{\defeq} \.{\LET} NowNext \.{\defeq} \.{\land}
 now\.{'} \.{\in} \{r \.{\in} Real \.{:} r \.{>} now\}
}%
\end{cpar}%
\begin{cpar}{0}{T}{F}{67.5}{0}{}%
\ensuremath{\.{\land} {\UNCHANGED} v
}%
\end{cpar}%
\begin{cpar}{1}{T}{F}{30.0}{0}{}%
\ensuremath{\.{\IN} \.{\land} now \.{\in} Real
}%
\end{cpar}%
\begin{cpar}{0}{T}{F}{10.0}{0}{}%
\ensuremath{\.{\land} {\Box}[NowNext]\_now
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\land} \A\, r \.{\in} Real \.{:} {\WF}\_now(NowNext \.{\land}
 (now\.{'}\.{>}r))
}%
\end{cpar}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{{\THEOREM}} \ensuremath{RTSpec \.{\implies} {\Box}RTTypeInv
}%
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\ceqdash{77}
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*} Last} \ensuremath{modified}
 \ensuremath{Sun} \ensuremath{Feb} \ensuremath{27}
 \ensuremath{21\.{:}28\.{:}57} \ensuremath{ART} \ensuremath{2022}
 \ensuremath{by} \ensuremath{sebapc
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*} Created} \ensuremath{Sun}
 \ensuremath{Feb} \ensuremath{27} \ensuremath{20\.{:}21\.{:}57}
 \ensuremath{ART} \ensuremath{2022} \ensuremath{by} \ensuremath{sebapc
}%
\end{cpar}%
\end{lcom}%
\end{document}
